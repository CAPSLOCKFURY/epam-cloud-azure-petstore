 ...
 */
public class MockTelemetryClient extends com.microsoft.applicationinsights.TelemetryClient {
	...
	private static final Logger logger = LoggerFactory.getLogger(MockTelemetryClient.class);
